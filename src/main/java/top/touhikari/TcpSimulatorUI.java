...
public class TcpSimulatorUI {
    ...
    // UI 常量与坐标
    private static final int SENDER_X = 50;
    private static final int RECEIVER_X = 600;
    private static final int TRANSIT_Y = 150;
    private static final double PACKET_SPEED_SEC = 1.5;
    ...
    public TcpSimulatorUI(TcpSimulator simulator) {
        ...
        this.windowRect = new Rectangle(60, 40, Color.TRANSPARENT);
